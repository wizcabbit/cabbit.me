...
<div id="resume" class="static">
  ...
  <div id="resume-content">
    ...
    <div class="resume-case">
      ...
      <ul class="description">
        <li>Designed and implemented RFID and Asset Management System for China Mobile</li>
        <li>Operation process optimization and process system architecture for China Everlight Bank</li>
      </ul>
    </div>
    <div class="resume-case">
    ...
    <div class="resume-case">
      ...
      <span class="company">Digihail Technology - <a href="//www.digihail.com/">Website</a></span>
