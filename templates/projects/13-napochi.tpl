...
<div id="proj-detail">
  <div id="proj-attribute">
    <h5>Client</h5>
    <span><a href="//napochi.com/">Napochi</a></span>
    <h5>Product Home</h5>
    <span><a href="//napochi.com/index.php/solutions/acuity">Napochi THISBoard</a></span>
    <h5>Time</h5>
    <span>Match, 2011</span>
  ...
  <div id="proj-intro">
    ...
    <h4>Login</h4>
    <img src="{$WEB_ROOT}/images/proj_13_login.jpg" alt="Napochi Login">
    <h4>Schedule</h4>
    <img src="{$WEB_ROOT}/images/proj_13_schedule.jpg" alt="Napochi Schedule">

    <h4>My Contribution</h4>
    <p>The project lasts so long time, because it needs adapted with HP's display device, I contributes:</p>
    <ul class="proj-list">
      <li>Technology solution selection, finally using .NET and Mono to build cross-platform solution;</li>
      <li>Front-end engineer, implements application user interface.</li>
    </ul>
  </div>
